...
class Snake {
  ...
  setDirection(input, previousDirection) {
    ...
    if (this.checkForReverseDirection(previousDirection)) {
      this.direction = previousDirection
    }
    // else {
    //   console.log("TRy to reverse ")
    // }
  }
...
checkForReverseDirection(previousDirection) {
  console.log(this.direction, previousDirection)
