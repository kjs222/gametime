...
class Game {
  ...
  snakeAteFood(){
    if (this.snake.head.x === this.food[0].x && this.snake.head.y === this.food[0].y) {
      this.food[0] = null;
      this.snake.addSegment();
    }
    else if (this.snake.head.x === this.food[1].x && this.snake.head.y === this.food[1].y) {
      this.food[1] = null;
      this.snake.addSegment();
    }
  }
  ...
  displayNumber() {
    $("#currentNumber").append(this.currentNumber.decimal);
  }
}
